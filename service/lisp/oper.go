...
type CiscoIOSXEWirelessLISPOper struct {
	CiscoIOSXEWirelessLISPOperData *CiscoIOSXEWirelessLISPOperData `json:"Cisco-IOS-XE-wireless-lisp-agent-oper:lisp-agent-oper-data"` // LISP Agent operational data (YANG: IOS-XE 17.12.1)
}

// CiscoIOSXEWirelessLISPOperData represents LISP Agent operational data (YANG: IOS-XE 17.12.1).
type CiscoIOSXEWirelessLISPOperData struct {
