...
type Dot11CfgData struct {
	ConfiguredCountries *Dot11ConfiguredCountries `json:"configured-countries,omitempty"` // Country code configuration container (Live: IOS-XE 17.12.6a)
	Dot11Entries        *Dot11Entries             `json:"dot11-entries,omitempty"`        // 802.11 protocol related config container (Live: IOS-XE 17.12.6a)
	Dot11acMcsEntries   *Dot11acMcsEntries        `json:"dot11ac-mcs-entries,omitempty"`  // 802.11ac MCS entries container (Live: IOS-XE 17.12.6a)
}
...
type Dot11Entry struct {
	Band                   string                  `json:"band"`                                 // Radio band identifier (2.4GHz, 5GHz, 6GHz) (Live: IOS-XE 17.12.6a)
	VoiceAdmCtrlSupport    *bool                   `json:"voice-adm-ctrl-support,omitempty"`     // Voice admission control support (Live: IOS-XE 17.12.6a)
	Dot11axCfg             *Dot11axCfg             `json:"dot11ax-cfg,omitempty"`                // 802.11ax configuration parameters (Live: IOS-XE 17.12.6a)
	AmpduEntries           *AmpduEntries           `json:"ampdu-entries,omitempty"`              // AMPDU aggregation configuration entries (Live: IOS-XE 17.12.6a)
	AmpduTxScheduler       *AmpduTxScheduler       `json:"ampdu-tx-scheduler,omitempty"`         // AMPDU transmission scheduler config (Live: IOS-XE 17.12.6a)
	AmsduEntries           *AmsduEntries           `json:"amsdu-entries,omitempty"`              // AMSDU aggregation configuration entries (Live: IOS-XE 17.12.6a)
	MediaStreamBandInfoCfg *MediaStreamBandInfoCfg `json:"media-stream-band-info-cfg,omitempty"` // Media stream band info config (Live: IOS-XE 17.12.6a)
	SpectrumCfg            *SpectrumCfg            `json:"spectrum-cfg,omitempty"`               // Radio spectrum management config (Live: IOS-XE 17.12.6a)
	Dot11axMcsEntries      *Dot11axMcsEntries      `json:"dot11ax-mcs-entries,omitempty"`        // 802.11ax MCS configuration entries (Live: IOS-XE 17.12.6a)
}

// Dot11axCfg represents 802.11ax feature related configuration.
type Dot11axCfg struct {
	HeMbssidCap *bool `json:"he-mbssid-cap,omitempty"` // 802.11ax multi-BSSID capability support (Live: IOS-XE 17.12.6a)
	HeBssColor  *bool `json:"he-bss-color,omitempty"`  // 802.11ax BSS color feature support (Live: IOS-XE 17.12.6a)
}

// AmpduEntries represents AMPDU configuration entries container.
type AmpduEntries struct {
	AmpduEntry []AmpduEntry `json:"ampdu-entry"` // List of AMPDU configurations (Live: IOS-XE 17.12.6a)
}

// AmpduEntry represents individual AMPDU configuration entry.
type AmpduEntry struct {
	Index                    int    `json:"index"`                        // AMPDU entry index identifier (Live: IOS-XE 17.12.6a)
	APF80211nAmpduTxPriority string `json:"apf-80211n-ampdu-tx-priority"` // AMPDU transmission priority setting (Live: IOS-XE 17.12.6a)
}

// AmpduTxScheduler represents AMPDU transmission scheduler configuration.
type AmpduTxScheduler struct{} // AMPDU tx scheduler config (Live: IOS-XE 17.12.6a)

// AmsduEntries represents AMSDU configuration entries container.
type AmsduEntries struct {
	AmsduEntry []AmsduEntry `json:"amsdu-entry"` // List of AMSDU configurations (Live: IOS-XE 17.12.6a)
}

// AmsduEntry represents individual AMSDU configuration entry.
type AmsduEntry struct {
	Index                    int    `json:"index"`                        // AMSDU entry index identifier (Live: IOS-XE 17.12.6a)
	APF80211nAmsduTxPriority string `json:"apf-80211n-amsdu-tx-priority"` // AMSDU transmission priority setting (Live: IOS-XE 17.12.6a)
}

// MediaStreamBandInfoCfg represents media stream band information configuration.
type MediaStreamBandInfoCfg struct{} // Media stream band info config (Live: IOS-XE 17.12.6a)

// SpectrumCfg represents radio spectrum configuration.
type SpectrumCfg struct {
	RRMEdEnable *bool `json:"rrm-ed-enable,omitempty"` // Radio resource management energy detection enable (Live: IOS-XE 17.12.6a)
}

// Dot11axMcsEntries represents 802.11ax MCS entries container.
type Dot11axMcsEntries struct {
	Dot11axMcsEntry []Dot11axMcsEntry `json:"dot11ax-mcs-entry"` // List of 802.11ax MCS configurations (Live: IOS-XE 17.12.6a)
}

// Dot11axMcsEntry represents individual 802.11ax MCS configuration entry.
type Dot11axMcsEntry struct {
	SpatialStream int    `json:"spatial-stream"` // Spatial stream count for MCS config (Live: IOS-XE 17.12.6a)
	Index         string `json:"index"`          // MCS index identifier (Live: IOS-XE 17.12.6a)
}

// Dot11acMcsEntries represents 802.11ac MCS entries container.
type Dot11acMcsEntries struct {
	Dot11acMcsEntry []Dot11acMcsEntry `json:"dot11ac-mcs-entry"` // List of 802.11ac MCS configurations (Live: IOS-XE 17.12.6a)
}
