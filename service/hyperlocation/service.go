...
func (s Service) GetOperational(ctx context.Context) (*model.HyperlocationOper, error) {
...
func (s Service) ListProfiles(ctx context.Context) (*model.HyperlocationProfiles, error) {
