...
type CiscoIOSXEWirelessBLEMgmtOper struct {
	CiscoIOSXEWirelessBLEMgmtOperData *CiscoIOSXEWirelessBLEMgmtOperData `json:"Cisco-IOS-XE-wireless-ble-mgmt-oper:ble-mgmt-oper-data"` // BLE management operational data (YANG: IOS-XE 17.12.1)
}

// CiscoIOSXEWirelessBLEMgmtOperData represents BLE management operational data (YANG: IOS-XE 17.12.1).
type CiscoIOSXEWirelessBLEMgmtOperData struct {
...
type BLEMgmtAp struct {
	...
	CmxID        *string `json:"cmx-id,omitempty"`        // ID of CMX controlling the AP (YANG: IOS-XE 17.12.1)
...
type BLEMgmtCmx struct {
	CmxID        string  `json:"cmx-id"`                   // CMX Identifier (YANG: IOS-XE 17.12.1)
