...
// TestService tests the General service using the minimal test pattern for oper-only service
...
// Test_GeneralJSONSerialization_Unit tests the JSON serialization/deserialization
