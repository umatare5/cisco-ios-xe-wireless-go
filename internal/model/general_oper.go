// Structs in this file were generated by AI from live RESTCONF JSON examples.
// Package model contains AI-generated response structs for the Cisco Wireless Network Controller API.
package model
