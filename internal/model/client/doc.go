// Package client provides data structures for Cisco IOS-XE wireless Client
//
...
//
// YANG References:
// - Cisco-IOS-XE-wireless-client-oper.yang (17.12.1)
// - Cisco-IOS-XE-wireless-client-oper.yang (17.18.1)
package client
