// Package model provides data models for rogue operational data.
package model

// RogueOper  represents the structure for rogue operational data.
type RogueOper struct {
	CiscoIOSXEWirelessRogueOperData struct {
		RogueStats      RogueStatsData      `json:"rogue-stats"`
		RogueData       []RogueDataDetail   `json:"rogue-data"`
		RogueClientData []RogueClientDetail `json:"rogue-client-data"`
		RldpStats       RldpStatsData       `json:"rldp-stats"`
	} `json:"Cisco-IOS-XE-wireless-rogue-oper:rogue-oper-data"`
}

// RogueStats  represents the structure for rogue statistics.
type RogueStats struct {
	RogueStats RogueStatsData `json:"Cisco-IOS-XE-wireless-rogue-oper:rogue-stats"`
}

// RogueData  represents the structure for rogue data.
type RogueData struct {
	RogueData []RogueDataDetail `json:"Cisco-IOS-XE-wireless-rogue-oper:rogue-data"`
}

// RogueClientData  represents the structure for rogue client data.
type RogueClientData struct {
	RogueClientData []RogueClientDetail `json:"Cisco-IOS-XE-wireless-rogue-oper:rogue-client-data"`
}

// RldpStats  represents the structure for RLDP statistics.
type RldpStats struct {
	RldpStats RldpStatsData `json:"Cisco-IOS-XE-wireless-rogue-oper:rldp-stats"`
}
