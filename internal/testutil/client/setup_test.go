...
func TestClient_AdditionalBranches(t *testing.T) {
...
func TestClient_ErrorSkip(t *testing.T) {
...
func TestClient_FatalSimulated(t *testing.T) {
	origController := os.Getenv("WNC_CONTROLLER")
	originalToken := os.Getenv("WNC_ACCESS_TOKEN")
	t.Cleanup(func() {
		if origController != "" {
...
func TestClient_SuccessPath(t *testing.T) {
...
func TestClient_ErrorSkipOnCreateError(t *testing.T) {
	origCreate := createCoreClient
	t.Cleanup(func() { createCoreClient = origCreate })
	createCoreClient = func(controller, token string, opts ...core.Option) (*core.Client, error) {
...
func TestClient_FatalReal(t *testing.T) {
...
func TestClientExtensiveCoverage(t *testing.T) {
...
func TestClientAttemptCoverage(t *testing.T) {
	origC, origT := os.Getenv("WNC_CONTROLLER"), os.Getenv("WNC_ACCESS_TOKEN")
	os.Unsetenv("WNC_CONTROLLER")
	os.Unsetenv("WNC_ACCESS_TOKEN")
...
func TestClientFailOnErrorDowngrade(t *testing.T) {
