...
const (
	...
	// Common error messages used across the SDK
	...
	ErrTagNameRequired       = "tag name is required"
	ErrAPMacRequired         = "AP MAC address is required"
	ErrRFTagEmpty            = "RF tag cannot be empty"
	ErrRFIDMACRequired       = "RFID MAC address is required"
	ErrSiteTagNameRequired   = "site tag name is required"
	ErrAPProfileNameRequired = "AP profile name is required"
)
