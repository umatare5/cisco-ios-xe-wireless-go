...
func TestErrorsServiceUnit_ServiceOperationError_Success(t *testing.T) {
	...
	t.Run("StandardFormat", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "ServiceOperationError should format message correctly")
	})
	...
	t.Run("DifferentParameters", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected,
	...
	t.Run("ErrorUnwrapping", func(t *testing.T) {
		...
		if !errors.Is(err, originalErr) {
			testutil.AssertTrue(t, errors.Is(err, originalErr), "Expected error to wrap original error")
		}
	})
}
...
func TestErrorsServiceUnit_SimpleServiceError_Success(t *testing.T) {
	...
	t.Run("StandardFormat", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "SimpleServiceError should format message correctly")
	})
...
func TestErrorsServiceUnit_ValidationError_Success(t *testing.T) {
	t.Run("MACAddress", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "ValidationError should format MAC address message correctly")
	})
	...
	t.Run("WLANId", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "ValidationError should format WLAN ID message correctly")
	})
	...
	t.Run("EmptyValue", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "ValidationError should format empty value message correctly")
	})
}
...
func TestErrorsServiceUnit_RequiredParameterError_Success(t *testing.T) {
	t.Run("APMacAddress", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "RequiredParameterError should format AP MAC message correctly")
	})
...
func TestErrorsServiceUnit_EmptyParameterError_Success(t *testing.T) {
	t.Run("SiteTag", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "EmptyParameterError should format site tag message correctly")
	})
	...
	t.Run("PolicyTag", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "EmptyParameterError should format policy tag message correctly")
	})
}
...
func TestErrorsServiceUnit_NotFoundError_Success(t *testing.T) {
	...
	t.Run("WLANWithId", func(t *testing.T) {
		...
		testutil.AssertErrorMessage(t, err, expected, "NotFoundError should format WLAN with ID message correctly")
	})
}
...
func TestErrorsServiceUnit_ErrorConstants_Success(t *testing.T) {
	t.Run("ErrorTemplates", func(t *testing.T) {
		...
		testutil.AssertStringEquals(t, operationErr, expectedOp, "Operation error template should format correctly")

		simpleErr := fmt.Sprintf("failed to %s", "connect")
		expectedSimple := "failed to connect"
		testutil.AssertStringEquals(t, simpleErr, expectedSimple, "Simple error template should format correctly")
		...
		testutil.AssertStringEquals(t, simpleOpErr.Error(), expectedSimpleOp,
		...
		testutil.AssertStringEquals(t, invalidParam, expectedInvalid,
		...
		testutil.AssertStringEquals(t, notFound, expectedNotFound, "Entity not found template should format correctly")

		emptyParam := fmt.Sprintf(ErrEmptyParameterTemplate, "tag")
		expectedEmpty := "tag cannot be empty"
		testutil.AssertStringEquals(t, emptyParam, expectedEmpty, "Empty parameter template should format correctly")

		requiredParam := fmt.Sprintf(ErrParameterRequiredTemplate, "MAC address")
		expectedRequired := "MAC address is required"
		testutil.AssertStringEquals(t, requiredParam, expectedRequired,
	...
	t.Run("ErrorConstants", func(t *testing.T) {
		...
		for _, constant := range constants {
			if constant == "" {
				testutil.AssertStringNotEmpty(t, constant, "Error constant should not be empty")
			}
		}
	})
	...
	t.Run("EntityTypeConstants", func(t *testing.T) {
		...
		for _, entityType := range entityTypes {
			if entityType == "" {
				testutil.AssertStringNotEmpty(t, entityType, "Entity type constant should not be empty")
			}
		}
	})
	...
	t.Run("ActionConstants", func(t *testing.T) {
		...
		for _, action := range actions {
			if action == "" {
				testutil.AssertStringNotEmpty(t, action, "Action constant should not be empty")
			}
		}
	})
}
