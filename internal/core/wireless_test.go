...
func TestGetRadioBandInfo(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if tt.expectedErr {
				helper.AssertError(t, err, "GetRadioBandInfo expected error")
				return
			}

			helper.AssertNoError(t, err, "GetRadioBandInfo unexpected error")

			helper.AssertIntEquals(t, int(info.Band), int(tt.expectedBand), "GetRadioBandInfo Band")

			helper.AssertIntEquals(t, int(info.SlotID), int(tt.expectedSlot), "GetRadioBandInfo SlotID")
		})
	}
}
...
func TestGetAdminStateMode(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			helper.AssertStringEquals(t, result, tt.expected, "GetAdminStateMode result")
		})
	}
}
...
func TestRadioBandConstants(t *testing.T) {
	...
	t.Run("RadioBand24GHzEnum", func(t *testing.T) {
		helper.AssertIntEquals(t, core.RadioBand24GHzEnum, 0, "RadioBand24GHzEnum")
	})

	t.Run("RadioBand5GHzEnum", func(t *testing.T) {
		helper.AssertIntEquals(t, core.RadioBand5GHzEnum, 1, "RadioBand5GHzEnum")
	})

	t.Run("RadioBand24GHzValue", func(t *testing.T) {
		expected := uint32(1)
		helper.AssertIntEquals(t, int(core.RadioBand24GHzValue), int(expected), "RadioBand24GHzValue")
	})

	t.Run("RadioBand5GHzValue", func(t *testing.T) {
		expected := uint32(2)
		helper.AssertIntEquals(t, int(core.RadioBand5GHzValue), int(expected), "RadioBand5GHzValue")
	})

	t.Run("RadioSlot24GHz", func(t *testing.T) {
		expected := uint8(0)
		helper.AssertIntEquals(t, int(core.RadioSlot24GHz), int(expected), "RadioSlot24GHz")
	})

	t.Run("RadioSlot5GHz", func(t *testing.T) {
		expected := uint8(1)
		helper.AssertIntEquals(t, int(core.RadioSlot5GHz), int(expected), "RadioSlot5GHz")
	})

	t.Run("AdminStateEnabled", func(t *testing.T) {
		expected := "admin-state-enabled"
		helper.AssertStringEquals(t, core.AdminStateEnabled, expected, "AdminStateEnabled")
	})

	t.Run("AdminStateDisabled", func(t *testing.T) {
		expected := "admin-state-disabled"
		helper.AssertStringEquals(t, core.AdminStateDisabled, expected, "AdminStateDisabled")
	})

	t.Run("OperationEnable", func(t *testing.T) {
		expected := "enable"
		helper.AssertStringEquals(t, core.OperationEnable, expected, "OperationEnable")
	})

	t.Run("OperationDisable", func(t *testing.T) {
		expected := "disable"
		helper.AssertStringEquals(t, core.OperationDisable, expected, "OperationDisable")
	})
}
