...
func TestServiceBaseUnit_Constructor_Success(t *testing.T) {
	t.Run("NewBaseService", func(t *testing.T) {
		t.Run("WithValidClient", func(t *testing.T) {
			...
			testutil.AssertPointerEquals(
				...
				service.client,
				mockClient,
				"Expected client to match mockClient",
			)
		})
		...
		t.Run("WithNilClient", func(t *testing.T) {
			...
			testutil.AssertPointerNil(t, service.client, "Expected client to be nil")
		})
	})
	...
	t.Run("Client", func(t *testing.T) {
		t.Run("ReturnsValidClient", func(t *testing.T) {
			...
			testutil.AssertPointerEquals(
				...
				retrievedClient,
				mockClient,
				"Expected retrieved client to match mockClient",
			)
		})
		...
		t.Run("ReturnsNilClient", func(t *testing.T) {
			...
			retrievedClient := service.Client()
			testutil.AssertPointerNil(t, retrievedClient, "Expected retrieved client to be nil")
		})
	})
	...
	t.Run("ServiceIntegration", func(t *testing.T) {
		...
		t.Run("EmbeddingWithNilClient", func(t *testing.T) {
			...
			testutil.AssertPointerNil(t, testService.Client(), "Expected embedded client to be nil")
		})
	})
}
