// Package cts provides configuration test functionality for the Cisco Wireless Network Controller API.
package cts
...
// TestDataCollector holds test data for CTS service functions
type TestDataCollector struct {
	mu      sync.Mutex
	CfgResp *model.CtsCfgResponse
	CfgErr  error
}

// TestCTSService tests all CTS service functions with the 4-pattern testing approach
