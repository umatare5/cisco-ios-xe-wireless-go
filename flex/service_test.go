...
// TestDataCollector holds test data for FLEX service functions
type TestDataCollector struct {
	mu      sync.Mutex
	CfgResp *model.FlexCfgResponse
	CfgErr  error
}

// TestFLEXService tests all FLEX service functions with the 4-pattern testing approach
