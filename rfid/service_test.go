// Package rfid provides configuration test functionality for the Cisco Wireless Network Controller API.
package rfid
...
// TestDataCollector holds test data for RFID service functions
type TestDataCollector struct {
	mu      sync.Mutex
	CfgResp *model.RfidCfgResponse
	CfgErr  error
}

// TestRFIDService tests all RFID service functions with the 4-pattern testing approach
func TestRFIDService(t *testing.T) {
