// Package rf provides configuration test functionality for the Cisco Wireless Network Controller API.
package rf
...
// TestDataCollector holds test data for RF service functions
type TestDataCollector struct {
	mu      sync.Mutex
	CfgResp *model.RfCfgResponse
	CfgErr  error
}

// TestRFService tests all RF service functions with the 4-pattern testing approach
func TestRFService(t *testing.T) {
