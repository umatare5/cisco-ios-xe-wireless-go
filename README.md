...
- **Experimental Features**: Cisco IOS-XE `17.18.x` (802.11be, Cisco Spaces, URWB, WAT features)
...
| API                                                                                                   | `GetOperational()` | `GetConfig()` | Others |
| ----------------------------------------------------------------------------------------------------- | :----------------: | :-----------: | :----: |
...
| [Spaces()](https://pkg.go.dev/github.com/umatare5/cisco-ios-xe-wireless-go@main/spaces)               |         🟨         |      ⬜️      |  ⬜️   |
| [URWB()](https://pkg.go.dev/github.com/umatare5/cisco-ios-xe-wireless-go@main/urwb)                   |         🟨         |      🟨       |  ⬜️   |
| [WAT()](https://pkg.go.dev/github.com/umatare5/cisco-ios-xe-wireless-go@main/wat)                     |        ⬜️         |      🟨       |  ⬜️   |
...
> - `wtpMac` refers to the **Radio MAC** as same as `radioMac`. `WTP` (Wireless Termination Point) is a term defined in [RFC 5415()](https://datatracker.ietf.org/doc/html/rfc5415) that denotes an AP.
...
Please read the **[Contribution Guide](./CONTRIBUTING.md)** before submitting PRs or issues. For additional guidance, please also see the following documents:
...
This project was developed with the assistance of **GitHub Copilot Agent**. Thanks to the global developer community who have contributed their knowledge and code to open source projects and public repositories.
